 ...
 * Version 3.2.0 : Correction de l'assignation des catégories (updateCategories) et finalisation.
 */
...
class Ps_VictronProducts extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Importe, met à jour et affiche les produits Victron Energy avec leurs catégories et images.');
    ...
    private function importProduct($productData, $categoriesMap)
    {
        ...
        try {
            $product->save();
            // *** CORRECTION ICI : Utilisation de updateCategories ***
